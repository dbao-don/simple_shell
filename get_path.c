...
/**
 * split_path - Get the full path to the file name
 * @file_token: name of exe to find
 * @path: holds all directories in PATH
 *
 * Return: full path to file if found and  NULL if otherwise
 */
